        ...
        <b-card class="mt-2">
          ...
          <b-form-row>
            <b-col cols="6">
              <b-form-group>
                <label>Blackout Start Time:</label>
                <font-awesome-icon v-if="this.recurring_start_time !== ''"
                                   icon='check'
                                   style="fontSize: 1rem; color: green;"/>
            ...
            <b-col cols="6">
              <b-form-group>
                <label>Blackout End Time:</label>
                <font-awesome-icon v-if="this.recurring_end_time !== ''"
                                   icon='check'
                                   style="fontSize: 1rem; color: green;"/>
          ...
          <b-form-row>
            <b-col cols="6">
              <b-form-group>
                ...
                <font-awesome-icon v-if="this.recurring_start_date !== ''"
                                   icon='check'
                                   style="fontSize: 1rem; color: green;"/>
            ...
            <b-col cols="6">
              <b-form-group>
                ...
                <font-awesome-icon v-if="this.recurring_end_date !== ''"
                                   icon='check'
                                   style="fontSize: 1rem; color: green;"/>
    ...
    export default {
        ...
        methods: {
          ...
          generateRule(){
            ...
            let start_year = parseInt(moment(this.recurring_start_date).clone().format('YYYY'))
            let start_month = parseInt(moment(this.recurring_start_date).clone().format('MM'))
            let start_day = parseInt(moment(this.recurring_start_date).clone().format('DD'))
            let start_hour = parseInt(moment(this.recurring_start_time).clone().format('HH'))
            let start_minute = parseInt(moment(this.recurring_start_time).clone().format('mm'))
            let end_year = parseInt(moment(this.recurring_end_date).clone().format('YYYY'))
            let end_month = parseInt(moment(this.recurring_end_date).clone().format('MM'))
            let end_day = parseInt(moment(this.recurring_end_date).clone().format('DD'))
            let end_hour = parseInt(moment(this.recurring_end_time).clone().format('HH'))
            let end_minute = parseInt(moment(this.recurring_end_time).clone().format('mm'))
            ...
            if(isNaN(start_year) == false || isNaN(end_year) == false) {
              ...
              array.forEach(date => {
                ...
                local_dates_array.push({start: start_utc_corrected, end: end_utc_corrected})
              })
            }
          ...
          checkRecurringInput(){
            if(this.selected_frequency.length > 0
              && this.recurring_start_date !== '' && this.recurring_start_time !== '' && this.recurring_end_date !== ''
              && this.recurring_end_time !== ''){
