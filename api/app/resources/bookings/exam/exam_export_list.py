...
class ExamList(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            check_params(start_param, end_param)
            ...
            exams = query_exams(csr, exam_type, start_date, end_date)
...
def check_params(start_param, end_param):
...
def query_exams(csr, exam_type, start_date, end_date):
